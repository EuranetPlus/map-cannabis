export const config = {
	mapTitle: 'cannabis-prevalance-europe', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-cannabis.vercel.app/', // The url provided when deploying the map on Vercel
